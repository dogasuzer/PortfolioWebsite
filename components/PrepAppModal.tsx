...
const PrepAppModal: React.FC<InfoModalProps> = ({ visible, onClose }) => {
          ...
          <div className="flex flex-col  ">
            <div className="w-2/4  md:w-3/4 flex place-self-center ">
              <ReactPlayer
                width="100%"
                height="100%"
                url="https://www.youtube.com/watch?v=8XoG-Wuregg"
              />
            </div>
            <div className=" flex text-center flex-row mt-4">
              <p className="text-white  text-sm lg:text-md">
                ...
                <p className="invisible lg:visible h-4 gap-4 lg:h-auto">
                  ...
                  ,<span className="text-yellow-500 font-bold"> Redux</span>,
                  <span className="text-yellow-500 font-bold">
                  ...
                  <span className="text-yellow-500 font-bold"> GraphQL</span>,
                  <span className="text-yellow-500 font-bold"> Lodash </span>{' '}
                </p>
              </p>
            </div>
